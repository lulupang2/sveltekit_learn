import { s as setContext, a as split_css_unit, c as create_ssr_component, e as escape, b as add_attribute, d as compute_slots, f as add_styles, g as subscribe, h as createEventDispatcher, i as spread, j as escape_object, v as validate_component, m as missing_component, k as each, o as onDestroy } from "../../chunks/ssr.js";
...
import { p as prefersReducedMotionStore, s as setQueryClientContext, u as useQueryClient } from "../../chunks/useQueryClient.js";
...
const Devtools = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { initialIsOpen = false } = $$props;
  let { buttonPosition = "bottom-left" } = $$props;
  let { position = "bottom" } = $$props;
  let { client = useQueryClient() } = $$props;
  let { errorTypes = [] } = $$props;
  let { styleNonce } = $$props;
  let ref;
  if ($$props.initialIsOpen === void 0 && $$bindings.initialIsOpen && initialIsOpen !== void 0)
    $$bindings.initialIsOpen(initialIsOpen);
  if ($$props.buttonPosition === void 0 && $$bindings.buttonPosition && buttonPosition !== void 0)
    $$bindings.buttonPosition(buttonPosition);
  if ($$props.position === void 0 && $$bindings.position && position !== void 0)
    $$bindings.position(position);
  if ($$props.client === void 0 && $$bindings.client && client !== void 0)
    $$bindings.client(client);
  if ($$props.errorTypes === void 0 && $$bindings.errorTypes && errorTypes !== void 0)
    $$bindings.errorTypes(errorTypes);
  if ($$props.styleNonce === void 0 && $$bindings.styleNonce && styleNonce !== void 0)
    $$bindings.styleNonce(styleNonce);
  return `<div class="tsqd-parent-container"${add_attribute("this", ref, 0)}></div>`;
});
const app = "";
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${validate_component(QueryClientProvider, "QueryClientProvider").$$render($$result, { client: data.queryClient }, {}, {
    default: () => {
      return `${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(Toast, "Toast").$$render($$result, {}, {}, {})} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
        pageFooter: () => {
          return `푸터`;
        },
        header: () => {
          return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
            trail: () => {
              return `<a class="btn btn-sm variant-ghost-surface" href="/" data-svelte-h="svelte-1gnn5sq">홈</a> <a class="btn btn-sm variant-ghost-surface" href="/board" data-svelte-h="svelte-wv68w8">게시판</a> <a class="btn btn-sm variant-ghost-surface" href="/chat" data-svelte-h="svelte-1eebl49">채팅</a> `;
            },
            lead: () => {
              return `<strong class="text-xl uppercase" data-svelte-h="svelte-1w2l8jb"></strong>`;
            }
          })} `;
        },
        default: () => {
      ...
      })} ${validate_component(Devtools, "SvelteQueryDevtools").$$render($$result, {}, {}, {})}`;
    }
  })}`;
});
export {
